...
|  9  | PayU - Twisto pay in 3 | :white_check_mark: | payer will be redirected to Twisto pay in 3 payment form                                                                                                |
| 10  | PayU - PayPo           | :white_check_mark: | payer will be redirected to PayPo payment form                                                                                                          |
| 11  | PayU - PragmaPay       | :white_check_mark: | payer will be redirected to PragmaPay payment form (only for business clients)                                                                          |
